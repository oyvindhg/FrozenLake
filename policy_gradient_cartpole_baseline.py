...
class value_net():
    def __init__(self, learning_rate, n_states, hidden_layer_size):
        ...
        self.diffs = self.output - self.new_value
...
def run(env, learning_rate, n_states, n_actions, hidden_layer_size, total_episodes, max_steps, ep_per_update, gamma):
    ...
    with tf.Session() as sess:
        ...
        #while(True):
            ...
            dell_history = return_history - value_history

            sess.run(baseline.update_batch, feed_dict={baseline.new_value: return_history})
